...
#include <DHT.h>
const char* ssid = "iChampi";
const char* password = "c1234567890";
const char* mqtt_server = "broker.mqtt-dashboard.com";
const int mqtt_port = 1883;
const char* mqtt_client = "76fec4dc-41ac-4f5a-8aec-7618a387fc2b";
const char* mqtt_username = "HvvhP4Q4qTaceLiAZ8b2TbsNZ2H1rJ41";
const char* mqtt_password = "bJtdfdaY3Ga9njMpVtruck3ZLDmssiSt";
